                    ...
                    <form action="/" method="post" class="row d-flex align-items-center justify-content-center">
                                ...
                                <div class="col-md-6 p-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control" id="InputPasswordConfirm" name="password_confirm" required>
                                        <?php formError($_SESSION['register']['errors']['password_confirm'] ?? null) ?>
                                    </div>
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" name="policy" value="1" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1" required >I agree with smth</label>
                                    </div>
                                </div>
                                <div class="col-12">
